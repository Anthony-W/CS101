...
public class SetTester
{
    ...
    private static final int EXCLUSIVE_DIFFERENCE = 16;
    private static final int SUBSET = 17;
    private static final int SUPERSET = 18;
    private static final int BARRAGE = 19;
    ...
    private static void testGet()
    {
        ...
        try
        {
            if (test_set.get(0) != null)
            {
                dump_error_message("index out of bounds not handled");
            }
